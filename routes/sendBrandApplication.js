    ...
    html: `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
                ...
                <![endif]-->
                  ...
                  <![endif]-->
                    ...
                    <tbody>
                      <tr>
                        <td style="padding:18px 0px 18px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 24px">${req.body.name} just filled out a brand application</span></div><div></div></div></td>
                      </tr>
                    </tbody>
                    ...
                    <tbody>
                      <tr>
                        <td style="padding:18px 0px 18px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: inherit"><strong>Brand name: </strong>${req.body.name}&nbsp;</div><div></div></div></td>
                      </tr>
                    </tbody>
                    ...
                    <tbody>
                      <tr>
                        <td style="padding:18px 0px 18px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: inherit"><strong>About their company: </strong>${req.body.about}&nbsp;</div><div></div></div></td>
                      </tr>
                    </tbody>
                    ...
                    <tbody>
                      <tr>
                        <td style="padding:18px 0px 18px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: inherit"><strong>How influencers should contact them: </strong>${req.body.contact}&nbsp;</div><div></div></div></td>
                      </tr>
                    </tbody>
                  </table></td>
                                                      </tr>
